...
/**
    IQTextField is the inherited class of UITextField for performing validation effectively. This class will handle all kind of validations with just few lines of code using regex and it is fully customisable. You can easily port this functionality in your existing code as well, you just need to change class name from UITextField to IQTextField and apply regex for performing validation.
 */
NS_CLASS_AVAILABLE_IOS(6_0) @interface IQTextField : UITextField<UITextFieldDelegate>{
 ...
 */
-(void)addConfirmValidationTo:(IQTextField *)txtPassword withMsg:(NSString *)msg;
